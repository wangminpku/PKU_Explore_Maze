...
public class TerrainLoader {
    ...
    public interface Feature {
        ...
        public static final String kUrban = "urban";
        public static final String kAirport1 = "airport1";
        ...
        public static final String kRunway1 = "runway1";
        ...
        public static final String kMountain = "mountain";
    }


    private static final String kWaterError = "error : water cell reading......";
    private static final String kUrbanError = "error : urban reading ......";
    private static final String kAirport1Error = "error : airport1 reading .......";
    ...
    private static final String kRunway1Error = "error : Runway1 connector reading......";
    ...
    private static final String kMountainError = "error : mountain reading ......";
    ...
    private void processTerrainSpec( ) throws ParseErrorException {
        ...
        case Feature.kWater:
            ...
            return;
        case Feature.kUrban:
        		readCells(TerrainType.kUrban, kUrbanError);
        		return;
        case Feature.kAirport1:
        		readCells(TerrainType.kAirport1,kAirport1Error);
        		return;
        case Feature.kBrush:
        ...
        case Feature.kHwy2:
            ...
            return;
        case Feature.kRunway1:
        		readPath(ConnType.runway1,kRunway1Error);
        		return;
        case Feature.kHwy4:
